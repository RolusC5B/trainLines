...
class Line {
    constructor(color) {
        this.color = color;//it prints this line as text
        this.connections = [];//it prints this line as text
    }
...
async function main() {
    ...
    //TODO: what happens if the user's name is ""?
    //tell the user where they are starting
    console.log(`Hello ${user.name}! You are on the ${user.currentLine.color}`)
...
//process.exit();//if this is outside of the function then the program wont run fully.